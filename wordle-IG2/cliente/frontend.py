...
Ahora se implementará animaciones desde el backend 
"""
...
class VentanaJuego(QWidget):
    ...
    # CAMBIO
    # Metodo encargado de cambiar colores de una celda
    def cambiar_colores(self, respuesta):
        ...
        self.labels[fila][columna].setStyleSheet(f"background-color: {data['color']}")
        self.labels[fila][columna].setText(data["letter"])
...
if __name__ == '__main__':
    ...
    procesador.senal_actualizar_celda.connect(ventana.cambiar_colores)
